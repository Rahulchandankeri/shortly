        ...
        <section className="footer-content">
          ...
          <div className="main-link">
            <div className="links-footer">
              <section className="link-section sec-1">
                <span>Features</span>
                <ul>
                  <li>
              ...
              <section className="link-section sec-2">
                <span>Resources</span>
                <ul>
                  <li>
                    <a href="#">Blog</a>
              ...
              <section className="link-section sec-3">
                <span>Company</span>
                <ul>
                  <li>
                    <a href="#">About</a>
          ...
          <div className="social-connect">
            <ul>
              ...
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#FFF" width="24" height="20">
